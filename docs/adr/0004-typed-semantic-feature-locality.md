...
catalog links, and source attribution. Existing metadata-driven behavior is treated as
...
- Translate upstream module structure directly: it may resemble the oracle but
  confuses compatibility tests with an implementation boundary.
...
through observable source, diagnostics, source mapping, lowering, or tooling
contracts. Inventory completeness and compatibility tests remain important,
