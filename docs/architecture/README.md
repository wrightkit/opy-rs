...
Use it for substantive implementation preflight. Architecture intent, implementation reality, compatibility tests, and historical design notes are separate:

- documents here state the current durable language/ownership contracts;
- source, Cargo metadata, tests, corpus, reference comparisons, and real projects establish implementation reality;
- `docs/language-support.md` records current tested support, not the definition of what the OverPy core language is;
...
| Current tested support | [`../language-support.md`](../language-support.md) plus executable tests |
| Pinned upstream identity and source attribution | [`../compatibility/upstream-references.md`](../compatibility/upstream-references.md) |
...
or implementation test results.
