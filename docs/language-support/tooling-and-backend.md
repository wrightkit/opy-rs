...
| Rule-name word filter | 🚧 Partial | The words `rigger` and `admin` are split with a soft hyphen; the remaining words the pinned upstream splits are tracked in wrightkit/opy-rs#366. |
