...
| Rule-name word filter | ✅ Supported | A rule name is written with a soft hyphen inside every word the Workshop refuses, and without invisible formatting characters, as the pinned upstream writes it. |
