//! Literal dictionary lookup lowering against the pinned canonical-WIR oracle.
...
#[test]
fn literal_dictionary_lookup_matches_the_pinned_oracle() {
    let dir = fixture_dir("dictionary-lookup");
